...
public class Activity8_2 {
    public static void main(String[] args) {
        ...
        System.out.println("Second row, second column value before sorting: " + cellValue2_2.getText());

        driver.findElement(By.xpath("//table[@id='sortableTable']/thead/tr/th[2]")).click();

        WebElement cellValues2_2 = driver.findElement(By.xpath("//table[@id='sortableTable']/tbody/tr[2]/td[2]"));
        System.out.println("Second row, second column value after sorting: " + cellValues2_2.getText());

        WebElement footer = driver.findElement(By.xpath("//table[@id='sortableTable']/tfoot/tr"));
        System.out.println("Table footer : " + footer.getText());
